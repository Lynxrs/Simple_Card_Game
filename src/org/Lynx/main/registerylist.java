...
import org.Lynx.main.cards.paladin;
...
public class registerylist {
    public static void init(){
        ...
        exemplecard test2 = new exemplecard("test2", 1, 65, 8, 16, 6, 3, 75,60, false);
        registercard(test2, Main.registeredacrds);

        exemplecard test1 = new exemplecard("test1",1,30,4,5,8,6,55, 45, true);
